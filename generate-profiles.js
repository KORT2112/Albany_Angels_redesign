  ...
  <header class="site-header solid-header">
    <div class="container header-inner">
      ...
      <button class="menu-toggle" id="menuToggle" aria-label="Toggle menu">
        <svg class="ham-icon" width="55" height="55" viewBox="0 0 100 100" aria-hidden="true">
          <line class="ham-line ham-top"    x1="20" y1="32" x2="80" y2="32" />
          <line class="ham-line ham-middle" x1="20" y1="50" x2="80" y2="50" />
          <line class="ham-line ham-bottom" x1="20" y1="68" x2="80" y2="68" />
        </svg>
      </button>
